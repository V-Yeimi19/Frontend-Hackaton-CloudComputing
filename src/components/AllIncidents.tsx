...
export default function AllIncidents({ incidents }: AllIncidentsProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      {/* Header */}
      <div className="mb-6">
        <h2 className="text-gray-900 mb-2">Dashboard de Incidentes</h2>
        <p className="text-gray-600">
          Visualiza todos los incidentes reportados en el sistema
        </p>
      </div>
        ...
        <TabsContent value={activeTab} className="space-y-4">
          {displayedIncidents.length === 0 ? (
            <div className="bg-white rounded-xl border p-12 text-center">
              ...
              <p className="text-gray-900 mb-2">No hay incidentes en esta categoría</p>
              <p className="text-gray-600">
